...
class CircularStdFont {
  ...
  static CircularStdFont get medium => CircularStdFont(fontFamily: "CircularStdMedium");
  static CircularStdFont get bold => CircularStdFont(fontFamily: "CircularStdBold");
  static CircularStdFont get black => CircularStdFont(fontFamily: "CircularStdBlack");
}
